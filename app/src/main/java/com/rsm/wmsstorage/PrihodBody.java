...
public class PrihodBody {
    ...
    public PrihodBody(int docNumber, String prodName, int SC, String prodEd, String part, String calibr, String ton, double plan, double fact, String cellName, String time, String user, int status) {
        DocNumber = docNumber;
        ProdName = prodName;
        this.SC = SC;
        ProdEd = prodEd;
